...
class UserView(View):
    ...
    def idsearchimpl(self, request):
        ...
        try:
            ...
            return render(request, "user/idsearch_ch.html", context)
        except:
    ...
    @request_mapping("/pwdsearch", method="get")
    def pwdsearch(self, request):
        return render(request, 'user/pwdsearch.html')

    @request_mapping("/pwdsearchimpl", method="get")
    def pwdsearchimpl(self, request):
        id = request.GET.get('input_id')
        ...
        return render(request, "user/pwdsearch.html", context)

    @request_mapping("/pwdsearchimpl2", method="get")
    def pwdsearchimpl2(self, request):
    ...
    @request_mapping("/pwdsearchsave", method="post")
    def pwdsearchsave(self, request):
        id = request.POST['id']
        pwd = request.POST['pwd']
        try:
            obj = Users.objects.get(user_id=id)
